        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center ">
              ...
              />
              <span className="text-2xl font-black">Terenske Sestre</span>
            </div>
            <p className="text-blue-200 text-sm leading-relaxed mb-4">
              Velika Porodica Terenske Sestre — zdravstvena nega u vašem domu, dostupna 24/7 širom
              Srbije.
            </p>
          ...
          {/* Kontakt */}
          <div>
            <h4 className="font-bold text-teal-200 mb-4 uppercase tracking-wider text-sm">
              Kontakt
            </h4>
            <ul className="space-y-3 text-sm">
              ...
              <li className="text-blue-200 flex items-center gap-2">🕐 Dostupni 24/7</li>
            </ul>
          </div>
